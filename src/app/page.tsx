              ...
              <div className="bg-gradient-to-br from-purple-100 to-pink-100 rounded-2xl p-8 border border-purple-200">
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="text-xl font-semibold text-gray-800 mb-2">{t('home.about.vision.title')}</h3>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="text-xl font-semibold text-gray-800 mb-2">{t('home.about.mission.title')}</h3>
                      <p className="text-gray-600">
            ...
            {[
              {
                ...
                description: t('home.services.haircut.description'),
                icon: "✂️",
                color: "from-blue-500 to-blue-600"
              },
              {
                title: t('home.services.coloring.title'),
                description: t('home.services.coloring.description'),
                icon: "🎨",
                color: "from-purple-500 to-purple-600"
              },
              {
                title: t('home.services.microResource.title'),
                description: t('home.services.microResource.description'),
                icon: "💇‍♀️",
              ...
              {
                title: t('home.services.makeup.title'),
                description: t('home.services.makeup.description'),
                icon: "💄",
                color: "from-green-500 to-green-600"
              },
              {
                title: t('home.services.hairCare.title'),
                description: t('home.services.hairCare.description'),
                icon: "💆‍♀️",
      ...
      <section className="py-16 sm:py-20 bg-white">
        <div className="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {t('home.values.principles').map((value: string, index: number) => (
          ...
          <Reveal>
            <div className="text-center mb-12">
              <SectionHeading 
                ...
                subtitle={t('home.promises.subtitle')} 
                icon={<HeartIcon />} 
              />
            </div>
          </Reveal>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {t('home.promises.list').map((promise: string, index: number) => (
