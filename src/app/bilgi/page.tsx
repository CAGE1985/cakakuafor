    ...
    <div className="fixed inset-0 bg-gradient-to-br from-gray-900 via-black to-gray-900 text-white flex items-center justify-center p-4 z-50">
      <div className="w-full max-w-md mx-auto text-center space-y-8">
        ...
        <div className="space-y-4">
          <h1 className="text-3xl font-bold text-white mb-6">{t('bilgi.title')}</h1>
          
          {/* Çalışma Saatleri */}
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
            <h2 className="text-lg font-semibold text-white mb-3">{t('bilgi.workingHours.title')}</h2>
            <div className="space-y-2 text-gray-300">
              <p>{t('bilgi.workingHours.weekday')}</p>
              <p>{t('bilgi.workingHours.saturday')}</p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          >
            <div className="flex flex-col items-center gap-3">
              ...
              <span className="text-white font-semibold text-sm">{t('bilgi.buttons.prices')}</span>
            </div>
          </button>
          ...
          >
            <div className="flex flex-col items-center gap-3">
              ...
              <span className="text-white font-semibold text-sm">{t('bilgi.buttons.reviews')}</span>
            </div>
          </button>
          ...
          <button
            ...
            className="group bg-gradient-to-br from-green-500 to-emerald-500 hover:from-green-600 hover:to-emerald-600 rounded-2xl p-6 border border-green-400/30 transition-all duration-300 transform hover:scale-105 hover:shadow-xl"
          >
            <div className="flex flex-col items-center gap-3">
              <div className="w-12 h-12 bg-white/20 rounded-full flex items-center justify-center">
                <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 20 20">
              ...
              <span className="text-white font-semibold text-sm">{t('bilgi.buttons.team')}</span>
            </div>
          </button>
          ...
          <button
            ...
            className="group bg-gradient-to-br from-pink-500 to-rose-500 hover:from-pink-600 hover:to-rose-600 rounded-2xl p-6 border border-pink-400/30 transition-all duration-300 transform hover:scale-105 hover:shadow-xl"
          >
            <div className="flex flex-col items-center gap-3">
              <div className="w-12 h-12 bg-white/20 rounded-full flex items-center justify-center">
              ...
              <span className="text-white font-semibold text-sm">{t('bilgi.buttons.instagram')}</span>
            </div>
          </button>
          ...
          >
            <div className="flex flex-col items-center gap-3">
              ...
              <span className="text-white font-semibold text-sm">{t('bilgi.buttons.whatsapp')}</span>
            </div>
          </button>

          {/* İletişim */}
          <button
            onClick={() => handleNavigation('/bizeulasin')}
            className="group bg-gradient-to-br from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 rounded-2xl p-6 border border-purple-400/30 transition-all duration-300 transform hover:scale-105 hover:shadow-xl"
          >
            <div className="flex flex-col items-center gap-3">
              <div className="w-12 h-12 bg-white/20 rounded-full flex items-center justify-center">
              ...
              <span className="text-white font-semibold text-sm">{t('bilgi.buttons.contact')}</span>
            </div>
          </button>
        </div>
      </div>
