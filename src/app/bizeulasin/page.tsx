          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <Reveal delayMs={100}>
              <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 hover:shadow-lg transition-shadow text-center">
                ...
                <h3 className="text-lg font-semibold text-gray-800 mb-2">{t('contact.channels.phone.title')}</h3>
                <p className="text-gray-600 mb-4">{t('contact.channels.phone.description')}</p>
                <a
            ...
            <Reveal delayMs={200}>
              <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 hover:shadow-lg transition-shadow text-center">
                ...
                <h3 className="text-lg font-semibold text-gray-800 mb-2">{t('contact.channels.whatsapp.title')}</h3>
                <p className="text-gray-600 mb-4">{t('contact.channels.whatsapp.description')}</p>
                <a
            ...
            <Reveal delayMs={300}>
              <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 hover:shadow-lg transition-shadow text-center">
                ...
                <h3 className="text-lg font-semibold text-gray-800 mb-2">{t('contact.channels.instagram.title')}</h3>
                <p className="text-gray-600 mb-4">{t('contact.channels.instagram.description')}</p>
                <a
            ...
            <Reveal delayMs={400}>
              <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 hover:shadow-lg transition-shadow text-center">
                ...
                <h3 className="text-lg font-semibold text-gray-800 mb-2">{t('contact.channels.facebook.title')}</h3>
                <p className="text-gray-600 mb-4">{t('contact.channels.facebook.description')}</p>
                <a
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <Reveal delayMs={100}>
              <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                <div className="flex items-start gap-4 mb-6">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-gray-800 mb-2">{t('contact.address.addressTitle')}</h3>
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-800 mb-1">{t('contact.address.workingHours.title')}</h4>
                      <p className="text-gray-600">
                        {t('contact.address.workingHours.schedule')}<br />
                        {t('contact.address.workingHours.closed')}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-800 mb-1">{t('contact.address.appointment.title')}</h4>
                      <p className="text-gray-600">
                        {t('contact.address.appointment.description')}
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <Reveal delayMs={200}>
              <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
                <h3 className="text-xl font-semibold text-gray-800 mb-4">{t('contact.address.map.title')}</h3>
                ...
                <div className="text-center">
                  ...
                  >
                    ...
                    {t('contact.address.map.getDirections')}
                  </a>
                </div>
              </div>
            </Reveal>
            ...
            <Reveal delayMs={100}>
              <div className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-2xl p-8 border border-blue-200">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <h3 className="text-xl font-semibold text-gray-800">{t('contact.directions.konyaalti.title')}</h3>
                </div>
                <p className="text-gray-700 leading-relaxed">
                  {t('contact.directions.konyaalti.description')}
                </p>
              </div>
            </Reveal>
            ...
            <Reveal delayMs={200}>
              <div className="bg-gradient-to-br from-pink-50 to-purple-50 rounded-2xl p-8 border border-pink-200">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <h3 className="text-xl font-semibold text-gray-800">{t('contact.directions.lara.title')}</h3>
                </div>
                <p className="text-gray-700 leading-relaxed">
                  {t('contact.directions.lara.description')}
                </p>
              </div>
            </Reveal>
          </div>
        ...
        <div className="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
          ...
          <Reveal delayMs={100}>
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 text-center">
              ...
              <h3 className="text-2xl font-bold text-gray-800 mb-4">{t('contact.youtube.channelTitle')}</h3>
              <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
                {t('contact.youtube.description')}
              </p>
              <a
              ...
              >
                ...
                {t('contact.youtube.visitChannel')}
              </a>
            </div>
          </Reveal>
        </div>
