...
export default function GaleriPage() {
  ...
  const GALERI_KATEGORILERI = [
    {
      id: "salonumuz",
      title: t('gallery.categories.salon.title'),
      subtitle: t('gallery.categories.salon.subtitle'),
      description: t('gallery.categories.salon.description'),
    ...
    {
      id: "videolar",
      title: t('gallery.categories.videos.title'),
      subtitle: t('gallery.categories.videos.subtitle'),
      description: t('gallery.categories.videos.description'),
    ...
    },
    {
      ...
      title: t('gallery.categories.bridal.title'),
      subtitle: t('gallery.categories.bridal.subtitle'),
      description: t('gallery.categories.bridal.description'),
    ...
    {
      id: "instagram",
      title: t('gallery.categories.instagram.title'),
      subtitle: t('gallery.categories.instagram.subtitle'),
      description: t('gallery.categories.instagram.description'),
    ...
    {
      id: "koleksiyon",
      title: t('gallery.categories.collection.title'),
      subtitle: t('gallery.categories.collection.subtitle'),
      description: t('gallery.categories.collection.description'),
    ...
    {
      id: "vitrin",
      title: t('gallery.categories.showcase.title'),
      subtitle: t('gallery.categories.showcase.subtitle'),
      description: t('gallery.categories.showcase.description'),
      href: "/galeri/vitrin",
      icon: "🖼️",
